...
#define CAP_FS_CREATE         0x0002
#define CAP_FS_DELETE         0x0003
#define CAP_MEM_MGMT          0x0004
#define CAP_DRV_ACCESS        0x0005
#define CAP_PROC_MGMT         0x0006
#define CAP_CAPS_MGMT         0x0007
